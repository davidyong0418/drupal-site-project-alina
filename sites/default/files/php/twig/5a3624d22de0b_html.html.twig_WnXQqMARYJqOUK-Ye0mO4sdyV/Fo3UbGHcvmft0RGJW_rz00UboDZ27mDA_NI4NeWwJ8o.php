...
/* themes/prisma/templates/layout/html.html.twig */
class __TwigTemplate_44365bff5afc53d128dc076d33f5be93c0995bf2b14ec030d7fb33ee62074104 extends Twig_Template
{
    ...
    {
        $tags = array("set" => 27);
        $filters = array("clean_class" => 29, "raw" => 37, "safe_join" => 38);
        $functions = array();
...
($context["root_path"] ?? null)) ? ("path-frontpage bg_image_home") : (\Drupal\Component\Utility\Html::getClass(($context["root_path"] ?? null)))), 2 => ((        // line 30
...
<html";
    ...
    <head-placeholder token=\"";
        ...
        echo "\">
                <script>
                  var az =  document.getElementsByName('az')[0];
                  var cat = document.getElementsByName('category')[0];
                  var cat_sub = document.getElementsByName('sub_category')[0];
                if(az){
                    document.getElementsByName('az')[0].options[0].innerHTML = \"A-Z\";
                } 
                if(cat){
                    document.getElementsByName('category')[0].options[0].innerHTML = \"Categorías\"; 
                } 
                if(cat_sub){
                    document.getElementsByName('sub_category')[0].options[0].innerHTML = \"Subcategorias\";
                }  
...
";
    ...
    {
        return "themes/prisma/templates/layout/html.html.twig";
    }
    ...
    {
        return array (  88 => 50,  84 => 49,  80 => 48,  74 => 45,  69 => 43,  61 => 38,  57 => 37,  52 => 35,  49 => 34,  47 => 31,  46 => 30,  45 => 29,  44 => 28,  43 => 27,);
    }
    ...
    {
        return new Twig_Source("", "themes/prisma/templates/layout/html.html.twig", "/var/www/html/prisma/themes/prisma/templates/layout/html.html.twig");
    }
}
